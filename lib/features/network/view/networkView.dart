...
class NetworkView extends GetView<NetworkController> {
          ...
          children: [
            ...
            Container(
              decoration: const BoxDecoration(
                image: DecorationImage(image: AssetImage(Images.networkbg), fit: BoxFit.cover),
              ),
            ),
            SafeArea(
              child: Column(
                  ...
                  Expanded(
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          SizedBox(height: 20),
                          _buildSectionHeader("Your events as Guest"),
                          _buildMenuCard([_buildMenuItem(Images.qr_code_scanner, "Scan to Join Event", "0"), _buildMenuItem(Images.people_outline, "Guest Events & members", "1")]),
                          SizedBox(height: 30),
                          _buildSectionHeader("Your events as Host"),
                          _buildMenuCard([_buildMenuItem(Images.calendar_today_outlined, "Create an Event", "2"), _buildMenuItem(Images.event_note, "Hosted Events, Guests & Codes", "3")]),
                        ],
                      ),
                    ),
                  ),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      "John",
                      style: TextStyle(fontFamily: AppConstants.fontFamily_Acre, fontSize: 14, fontWeight: FontWeight.w700),
                    ),
  ...
  Widget _buildMenuCard(List<Widget> children) {
    return Container(
      decoration: BoxDecoration(color: AppColors.whites, borderRadius: BorderRadius.circular(15)),
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(
                title,
                style: TextStyle(fontSize: 18, fontFamily: AppConstants.fontFamily_Acre, fontWeight: FontWeight.w500),
              ),
            ),
            Container(
  ...
  //   String title = "Your events as Guest";
  ...
  //             child: Text(
  //               title,
  //               style: TextStyle(fontSize: 22, fontFamily: AppConstants.fontFamily_Acre, fontWeight: FontWeight.w600),
  //             ),
  //           ),
  //
  //           Container(
  ...
  //             height: 368,
  //             decoration: const BoxDecoration(
  //               image: DecorationImage(image: AssetImage(Images.qr), fit: BoxFit.cover),
  //             ),
  //           ),
  ...
  //                   style: const TextStyle(fontSize: 18, color: Colors.white, fontWeight: FontWeight.bold, fontFamily: AppConstants.fontFamily_Acre),
  //                 ),
  //               ),
  //             ),
  //           ),
